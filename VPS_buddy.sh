...
if [[ ! -f $ToolsPath/VPS_buddy/common_tools ]]; then
    ...
    PACKAGES="cargo jq chromium-browser ruby-full rubygems libcurl4-openssl-dev libssl-dev libxml2 libxml2-dev libxslt1-dev build-essential libgmp-dev zlib1g-dev dnsutils ghex parallel python2 python3.9 python-is-python3"
